...
main_url = "http://202.150.161.170:201/"
nomor_id = 0
...
class scrapMaxim(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.http.Request('http://202.150.161.170:201/', self.login_action)
    ...
    def login_action(self,response):
        ...
        return scrapy.FormRequest.from_response(
            ...
            formdata={
                'action' : token,
                'signin-username':'janindri',
                'signin-password':'jw210188'},
    ...
    def logged_in(self, response):
        ...
        return scrapy.http.Request('http://202.150.161.170:201/device',self.parse)
